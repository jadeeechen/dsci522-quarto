...
![Horse population (1906 - 1972)](../results/horse_pops_plot.png){#fig-horse-pop width=70%}
...
![Horse sample standard deviations (1906 - 1972)](../results/horse_pops_plot_largest_sd.png){#fig-horse-sd width=70%}
